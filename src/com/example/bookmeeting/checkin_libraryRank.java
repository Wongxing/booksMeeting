...
public class checkin_libraryRank extends Activity {
	public String user;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.checkin_libraryrank);
			...
			if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
				...
				if (aLength == 1) {
					...
					SimpleAdapter mSchedule = new SimpleAdapter(this, mylist,
							R.layout.libraryrankview, new String[] { "CheckNumber",
									"checkUserName", "checkDays" }, new int[] {
									R.id.CheckNumber, R.id.checkUserName,
									R.id.checkDays });
					
					list = (ListView)findViewById(R.id.libraryRankView);
