...
public class chating extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    final EditText message = (EditText) findViewById(R.id.message);
	    	...
	    	String url = "http://1.tsthelo.sinaapp.com/chat.php";
	    		...
	    		if(httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK){
	    			...
	    			String date;
	    	              try {
	    		            	  ...
	    		            	  SimpleAdapter mSchedule = new SimpleAdapter(this, mylist, R.layout.huilistview,  new String[] {"Time", "Pos", "Topic"}, new int[] {R.id.Time,R.id.Pos,R.id.Topic});  
	    		            	  
	    		            	  list = (ListView) findViewById(R.id.huiListView);  
	    		            	  list.setAdapter(mSchedule);
	    		            	  
	    		            	  Intent findIntent=new Intent(chating.this,chat.class);
