...
public class attendPeople extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
	...
	String url = "http://1.tsthelo.sinaapp.com/meeting_attendPeople.php";
...
public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {   
    ...
    //Toast.makeText(getApplicationContext(), "你选择了第"+arg2+"个Item，Time的值是："+time+"Pos的值是:"+pos+"，主题是："+topic, Toast.LENGTH_SHORT).show();   
			...
			String url = "http://1.tsthelo.sinaapp.com/friend.php";
	        HttpPost httpRequest = new HttpPost(url);
	        
	        List<NameValuePair> params = new ArrayList<NameValuePair>();
	        params.add(new BasicNameValuePair("username1", time));
	        params.add(new BasicNameValuePair("username2", user));
	        try {
				HttpEntity httpEntity = new UrlEncodedFormEntity(params,"utf-8");
				httpRequest.setEntity(httpEntity);
				...
				if(httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK){
					...
					Intent first2Intent=new Intent(attendPeople.this,main_page.class);
